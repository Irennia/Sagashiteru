			...
			<header>
				<nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
				   <div class="container">
					  ...
					  <a class="navbar-brand mx-auto" href="/sagashiteru" style="color: #022557;">Sagashi<span style="color: #d59c01;">teru</span></a>
					  <div class="collapse navbar-collapse" id="navbarCollapse1">
					    <ul class="navbar-nav ml-auto">
					    
					     <li class="nav-item"> <a class="nav-link" href="/sagashiteru" style="color: #022557;">Inicio<span class="sr-only">(current)</span></a> </li>
					     <li class="nav-item"> <a class="nav-link" href="/contacto" style="color: #022557;">Nosotros</a> </li>
					     <li class="nav-item"> 
				...
				<nav
					...
					<div class="container">
						...
						<a class="navbar-brand mx-auto" href="/sagashiteru"
							style="color: #022557;">Sagashi<span style="color: #d59c01;">teru</span></a>
						<div class="collapse navbar-collapse" id="navbarCollapse1">
							<ul class="navbar-nav ml-auto">
			
								<li class="nav-item"><a class="nav-link" href="/sagashiteru"
									style="color: #022557;">Inicio<span class="sr-only">(current)</span></a>
								</li>
								<li class="nav-item"><a class="nav-link" href="/contacto"
									style="color: #022557;">Nosotros</a></li>
								<li class="nav-item">
									<ul class="nav navbar-nav">
										<li class="dropdown" style="margin-top: 8px; margin-left: 30px; line-height: 2;">
											...
											<ul class="dropdown-menu" style="padding: 20px;">
												...
												<li class="divider"></li>
												<li><a href="/gestionhotel" style="color: #022557; text-decoration: none;">Gesti�n</a></li>
												<li class="divider" style="margin-top: 10px;"></li>
												<li><a href="/cerrarsesion"><button class="btn btn-danger" style="height: 40px;">Cerrar Sesión</button></a></li>
											</ul></li>
									</ul>
